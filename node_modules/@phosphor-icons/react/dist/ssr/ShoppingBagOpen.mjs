...
var t = (o, e, p) => e in o ? i(o, e, { enumerable: !0, configurable: !0, writable: !0, value: p }) : o[e] = p, a = (o, e) => {
  for (var p in e || (e = {}))
    g.call(e, p) && t(o, p, e[p]);
  if (r)
    for (var p of r(e))
      s.call(e, p) && t(o, p, e[p]);
  return o;
}, m = (o, e) => n(o, f(e));
import S, { forwardRef as c } from "react";
import h from "../lib/SSRBase.mjs";
import B from "../defs/ShoppingBagOpen.mjs";
const R = c((o, e) => /* @__PURE__ */ S.createElement(h, m(a({ ref: e }, o), { weights: B })));
