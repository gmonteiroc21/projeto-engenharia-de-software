...
var p = (e, o, t) => o in e ? s(e, o, { enumerable: !0, configurable: !0, writable: !0, value: t }) : e[o] = t, a = (e, o) => {
  for (var t in o || (o = {}))
    i.call(o, t) && p(e, t, o[t]);
  if (r)
    for (var t of r(o))
      d.call(o, t) && p(e, t, o[t]);
  return e;
}, m = (e, o) => c(e, f(o));
import l, { forwardRef as g } from "react";
import R from "../lib/SSRBase.mjs";
import n from "../defs/ApplePodcastsLogo.mjs";
const w = g((e, o) => /* @__PURE__ */ l.createElement(R, m(a({ ref: o }, e), { weights: n })));
