...
var i = (o, r, t) => r in o ? n(o, r, { enumerable: !0, configurable: !0, writable: !0, value: t }) : o[r] = t, a = (o, r) => {
  for (var t in r || (r = {}))
    p.call(r, t) && i(o, t, r[t]);
  if (e)
    for (var t of e(r))
...
const u = c((o, r) => /* @__PURE__ */ w.createElement(R, m(a({ ref: r }, o), { weights: d })));
