...
var i = (r, e, o) => e in r ? s(r, e, { enumerable: !0, configurable: !0, writable: !0, value: o }) : r[e] = o, t = (r, e) => {
  for (var o in e || (e = {}))
    f.call(e, o) && i(r, o, e[o]);
  if (m)
    for (var o of m(e))
      g.call(e, o) && i(r, o, e[o]);
  return r;
}, a = (r, e) => p(r, l(e));
import H, { forwardRef as S } from "react";
import c from "../lib/SSRBase.mjs";
import h from "../defs/HourglassSimpleHigh.mjs";
const R = S((r, e) => /* @__PURE__ */ H.createElement(c, a(t({ ref: e }, r), { weights: h })));
