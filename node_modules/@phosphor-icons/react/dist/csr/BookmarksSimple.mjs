...
var t = (e, o, m) => o in e ? p(e, o, { enumerable: !0, configurable: !0, writable: !0, value: m }) : e[o] = m, a = (e, o) => {
  for (var m in o || (o = {}))
    c.call(o, m) && t(e, m, o[m]);
  if (r)
    for (var m of r(o))
      k.call(o, m) && t(e, m, o[m]);
  return e;
}, i = (e, o) => s(e, f(o));
import l, { forwardRef as n } from "react";
import B from "../lib/IconBase.mjs";
import d from "../defs/BookmarksSimple.mjs";
const w = n((e, o) => /* @__PURE__ */ l.createElement(B, i(a({ ref: o }, e), { weights: d })));
